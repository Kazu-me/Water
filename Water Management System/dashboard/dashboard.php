                ...
                <div class="card h-100 border-0 shadow-sm" style="background: linear-gradient(135deg, #007bff 70%, #6dd5ed 100%); color: #fff; border-radius: 12px;">
                    <div class="card-body p-3">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <h6 class="card-title mb-1 fs-6" style="font-size:1rem;">Active Customers</h6>
                                <h2 class="mb-0 fw-bold" style="font-size:1.25rem;"><?php echo number_format($customer['count']); ?></h2>
                            </div>
            ...
            <div class="col-6 col-lg-2 mb-2">
                <div class="card h-100 border-0 shadow-sm" style="background: linear-gradient(135deg, #dc3545 70%, #ffb3b3 100%); color: #fff; border-radius: 12px;">
                    <div class="card-body p-3">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <h6 class="card-title mb-1 fs-6" style="font-size:1rem;">Disconnected Customers</h6>
                                <h2 class="mb-0 fw-bold" style="font-size:1.25rem;"><?php echo number_format($disconnected['disconnected_count']); ?></h2>
                                <span class="badge bg-danger" style="font-size:0.9rem;">REALTIME</span>
                            </div>
                            <i class="fas fa-user-slash fa-lg opacity-75"></i>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-6 col-lg-2 mb-2">
                <div class="card h-100 border-0 shadow-sm" style="background: linear-gradient(135deg, #28a745 70%, #a8e063 100%); color: #fff; border-radius: 12px;">
                    <div class="card-body p-3">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <h6 class="card-title mb-1 fs-6" style="font-size:1rem;">Paid Bills</h6>
                                <h2 class="mb-0 fw-bold" style="font-size:1.25rem;"><?php echo number_format($billing['paid_count']); ?></h2>
                                <span class="badge bg-success" style="font-size:0.9rem;">REALTIME</span>
                            </div>
            ...
            <div class="col-6 col-lg-2 mb-2">
                <div class="card h-100 border-0 shadow-sm" style="background: linear-gradient(135deg, #ffc107 70%, #fff6a3 100%); color: #333; border-radius: 12px;">
                    <div class="card-body p-3">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <h6 class="card-title mb-1 fs-6" style="font-size:1rem;">Pending Bills</h6>
                                <h2 class="mb-0 fw-bold" style="font-size:1.25rem;"><?php echo number_format($billing['pending_count']); ?></h2>
                                <span class="badge bg-warning text-dark" style="font-size:0.9rem;">REALTIME</span>
                            </div>
            ...
            <div class="col-6 col-lg-2 mb-2">
                <div class="card h-100 border-0 shadow-sm" style="background: linear-gradient(135deg, #17a2b8 70%, #6dd5ed 100%); color: #fff; border-radius: 12px;">
                    <div class="card-body p-3">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <h6 class="card-title mb-1 fs-6" style="font-size:1rem;">Total Collections</h6>
                                <h2 class="mb-0 fw-bold" style="font-size:1.25rem;">₱<?php echo number_format($billing['paid_amount'], 2); ?></h2>
                            </div>
                            <i class="fas fa-peso-sign fa-lg opacity-75"></i>
                        </div>
                    </div>
                </div>
            </div>
